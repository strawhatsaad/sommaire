      ...
      >
        <div className="flex justify-between items-center gap-4">
          <div>
            ...
            <p className="text-base-content/80 font-semibold mt-2">
              {description}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2 flex justify-center w-full">
          <Link
            href={paymentLink}
            className={cn(
              "w-full rounded-full flex items-center justify-center gap-2 bg-linear-to-r from-rose-800 to-rose-500 hover:from-rose-500 hover:to-rose-800 text-white border-2 py-2 transition-colors duration-500",
              id === "pro"
                ? "border-rose-900"
